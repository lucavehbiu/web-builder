          ...
          <div className="bg-blue-500/10 rounded-2xl p-4 border border-blue-500/20 mb-8">
            <div className="flex items-center justify-center mb-2">
              ...
              <span className="text-blue-300 font-medium text-sm">
                {locale === 'sq' ? '3-Ditë Garanci Kthimi' : '3-Day Refund Guarantee'}
              </span>
            </div>
            <p className="text-xs text-gray-400 text-center">
              {locale === 'sq' 
                ? 'Kthim i plotë i parave brenda 3 ditëve - pa pyetje'
                : 'Full refund within 3 days - no questions asked'}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-6 border border-purple-500/20 mb-8">
            <div className="flex items-center justify-center mb-3">
              ...
              <h3 className="text-lg font-semibold text-white">
                {locale === 'sq' ? 'Menaxhoni Abonésën Tuaj' : 'Manage Your Subscription'}
              </h3>
            </div>
            <p className="text-gray-300 text-sm mb-4 text-center">
              {locale === 'sq' 
                ? 'Përdorni portalin e klientit për të menaxhuar pagesën, përditësuar metodën e pagesës, ose shkarkuar faturat.'
                : 'Use the customer portal to manage billing, update payment methods, or download invoices.'}
            </p>
            <a
              href="https://billing.stripe.com/p/login/cNi4gz1WHfpj3Tu2gugQE00"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center w-full px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
              </svg>
              {locale === 'sq' ? 'Akseso Portalin e Klientit' : 'Access Customer Portal'}
            </a>
          </div>
